...
def main(subscription_id: str, subscription_name: str) -> utils.ExportResult:
    ...
    if not tables:
        raise utils.NoResourcesFound("route tables")
    ...
    return utils.ExportResult(rows=len(rows) + len(route_rows), filename=filename, errors=[])


if __name__ == "__main__":
    import runner

    runner.run_exporter(main, "route-tables")
