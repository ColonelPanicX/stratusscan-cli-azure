...
def main(subscription_id: str, subscription_name: str) -> utils.ExportResult:
    ...
    if not apps:
        raise utils.NoResourcesFound("container apps")
    ...
    for app in apps:
        ...
        rows.append({
            ...
            "Provisioning State": utils.s(app.provisioning_state),
            ...
            "Active Revisions Mode": utils.s(getattr(cfg, "active_revisions_mode", None)) if cfg else "",
...
if __name__ == "__main__":
    ...
    runner.run_exporter(main, "container-apps")
